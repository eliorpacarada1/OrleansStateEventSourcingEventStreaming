...
{
    public class GrainObserverManager<TObserver> : GrainObserverManager<IAddressable, TObserver>
    {
        public GrainObserverManager(TimeSpan expiration, ILogger log, string logPrefix) : base(expiration, log, logPrefix)
        {
        }
    }
    ...
    /// The observer type.
    /// </typeparam>
    public class GrainObserverManager<TAddress, TObserver> : IEnumerable<TObserver>
    {
        /// <summary>
        /// The log prefix.
        /// </summary>
        ...
        public GrainObserverManager(TimeSpan expiration, ILogger log, string logPrefix)
        {
